...
!(async () => {
  ...
  let res = await getAuthorShareCode('Aaron-lv/updateTeam/master/shareCodes/wish.json')
  if (!res) {
    $.http.get({url: 'gh/Aaron-lv/updateTeam@master/shareCodes/wish.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('/gh/Aaron-lv/updateTeam@master/shareCodes/wish.json')
  }
