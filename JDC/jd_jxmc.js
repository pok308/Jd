...
function getGetRequest(url) {
  ...
  if(JXUserAgent){
    ...
    ua = `jdpingou;iPhone;5.1.0;14.6;${randomWord(false,40,40)};network/wifi;model/iPhone11,6;appBuild/100623;ADID/00000000-0000-0000-0000-000000000000;supportApplePay/1;hasUPPay/0;pushNoticeIsOpen/0;hasOCPay/0;supportBestPay/0;session/694;pap/JA2019_3111789;brand/apple;supportJDSHWK/1;Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148`;
  }
  const method = `GET`;
  let headers = {
